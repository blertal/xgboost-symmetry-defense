...
training["HIGGS"]    = "HIGGS_s.test0"#"HIGGS_s.train0"
...
#X_test = X_test[:limit,:]
#X_inv = X[:limit,:]
#X_test_inv = X_test_inv[:limit,:]
#y = y[:limit]
#y_test = y_test[:limit]
#y_inv = y[:limit]
#y_test_inv = y_test_inv[:limit]
...
#bst.dump_model('inverted/models/model-binary-mnist.json', dump_format='json')
#bst_inv.dump_model('inverted/models/model-binary-mnist-inverted.json', dump_format='json')
#bst.save_model("inverted/models/model-binary-mnist.model")
#bst.save_model("inverted/models/model-binary-mnist-inverted.model")
