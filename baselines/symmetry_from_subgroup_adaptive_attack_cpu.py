from Sign_OPT_adaptive import OPT_attack_sign_SGD_cpu
from HSJA_adaptive import HSJA # adaptive hsja
from OPT_adaptive import OPT_attack_lf
from cube_attack_adaptive import Cube
...
for i, (xi, yi) in enumerate(test_loader):
    ...
    inv_flipped_xi = 1.0 - flipped_xi
        
    if not ((amodel.predict_label(xi) == yi and amodel.predict_label(1.0-xi) == yi)  or  (amodel.predict_label(xi) == yi and amodel.predict_label(flipped_xi) == yi)  or  (amodel.predict_label(xi) == yi and amodel.predict_label(inv_flipped_xi) == yi)  or  (amodel.predict_label(1.0-xi) == yi and amodel.predict_label(flipped_xi) == yi)  or  (amodel.predict_label(1.0-xi) == yi and amodel.predict_label(inv_flipped_xi) == yi)  or  (amodel.predict_label(flipped_xi) == yi and amodel.predict_label(inv_flipped_xi) == yi) ):
        print(f"Fail to classify example {i+1}. No need to attack.")
        continue
    else:
    ...
    if succ:
        ...
        inv_flipped_adv = 1.0 - flipped_adv
        
        #adv_check = False
        #if not 
        if ((amodel.predict_label(adv) == yi and amodel.predict_label(1.0-adv) == yi)  or  (amodel.predict_label(adv) == yi and amodel.predict_label(flipped_adv) == yi)  or (amodel.predict_label(adv) == yi and amodel.predict_label(inv_flipped_adv) == yi)  or  (amodel.predict_label(1.0-adv) == yi and amodel.predict_label(flipped_adv) == yi)  or  (amodel.predict_label(1.0-adv) == yi and amodel.predict_label(inv_flipped_adv) == yi)  or  (amodel.predict_label(flipped_adv) == yi and amodel.predict_label(inv_flipped_adv) == yi) ):
        	#adv_check = True    
        ...
        #print('######',amodel.predict_label(adv), yi)
        ...
        s2 = amodel.predict_label(1.0-adv)
        ...
        s4 = amodel.predict_label(1.0-adv_flip)
